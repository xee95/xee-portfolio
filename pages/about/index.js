  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 ">
        ...
        initial="hidden"
        animate="show"
        exit="hidden" className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">3 years ago, I began freelancing as a developer. Since then, I've done remote work for agencies,
          consultants for startups, and collaborated on digital products for business and consumer use </motion.p>
          {/* counter */}
            ...
            <div className="flex-1 flex xl:gap-x-6"> 
              ...
              after:absolute after:top-0 after:right-[20%]">
                <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">
                  ...
                  <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">Year's of Experience</div>
                  </div>
              ...
              after:absolute after:top-0 after:right-[20%]">
                <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">
                  ...
                  <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">Satiesfied Clients</div>
                  </div>
                  {/* Finished Porjects */}
                ...
                <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">
                  ...
                  <div className="text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]">Finished Porjects</div>
                  </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col w-full  xl:max-w-[48%] h-[480px]">
          ...
          <div className='py-2 xl:py-6 flex flex-col gap-y-2  xl:gap-y-4 items-center xl:items-start'>
            {aboutData[index].info.map((items, itemindex) => {
              return (
                <div key={itemindex} className='flex-1 flex flex-col md:flex-row max-w-max gap-x-2 itmes-center
                text-white/60'>
